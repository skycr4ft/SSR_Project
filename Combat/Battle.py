...
#         characters = []
#         for squad in squads:
#             characters.append(squad.get_next_character())
#
#         # if character1 is None:
#         #     print(f'Squad {squad1.name} - idle')
#         # else:
...
#
#         # Determine if the squads are in the rage skill phase
#         is_rage_skill_phases = []
#         for squad in squads:
#             is_rage_skill_phases.append(squad.rage_skill_phase > 0)
#
#         # Get the skills for this turn
#         skills = []
#         for character, is_rage_skill_phase in zip(characters, is_rage_skill_phases):
#             skills.append(character.take_action(is_rage_skill_phase) if character is not None else None)
#
#
#         # select_targets
#         is_cast_lists, target_lists = [], []
#         for character, skill in zip(characters, skills):
#             is_cast_list, target_list = character.select_targets(self.squads, skill) if character is not None \
#                 else ([], [])
#             is_cast_lists.append(is_cast_list)
