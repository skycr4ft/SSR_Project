...
Nitro_skill = Skill(name='奈乔技能', definition='active', type='instant',
                    effects_param=[{'effect_type': 'skill_dmg', 'dmg_coef': 4.0, 'target_area': 'single'},
                                   {'effect_type': 'skill_dmg', 'dmg_coef': 4.0, 'cast_prob_lower_bound': 0.5,
...
Don_skill = Skill(name='东技能', definition='active', type='instant',
                  effects_param=[{'effect_type': 'skill_dmg', 'dmg_coef': 2.0, 'max_targets': 1,
                                  'target_area': 'single'},
                                 {'effect_type': 'buff', 'buffs': {'skill_dmg_rcv_inc': -0.25}, 'max_targets': 2,
...
GoldenNose_skill = Skill(name='金鼻子技能', definition='active', type='instant',
                         effects_param=[
                             {'effect_type': 'skill_dmg', 'dmg_coef': 2.0, 'max_targets': 1, 'target_area': 'single'},
...
FemaleDoctor_skill = Skill(name='女医生技能', definition='active', type='instant',
                           effects_param=[
                               {'effect_type': 'heal', 'dmg_coef': 2.4, 'max_targets': 2, 'target_area': 'single',
                                'target_type': 'ally'}, ])
