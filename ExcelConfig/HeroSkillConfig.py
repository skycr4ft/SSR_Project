...
Gem_skills = [Skill(name='杰玛技能', definition='active', type='instant',
                    effects_param=[{'effect_type': 'skill_dmg', 'dmg_coef': 0.67, 'max_targets': 3,
                                    'target_area': 'single'}]),
              Uni_attack]

# version: 2
Nitro_skills = [Skill(name='奈乔技能', definition='active', type='instant',
                      effects_param=[{'effect_type': 'skill_dmg', 'dmg_coef': 1.67, 'target_area': 'single'},
...
Don_skills = [Skill(name='东技能', definition='active', type='instant',
                    effects_param=[{'effect_type': 'skill_dmg', 'dmg_coef': 1.0, 'max_targets': 1,
                                    'target_area': 'single'},
                                   {'effect_type': 'buff', 'buffs': {'skill_dmg_rcv_inc': -0.3}, 'max_targets': 2,
...
Massager_skills = [Skill(name='按摩师技能', definition='active', type='instant',
                         effects_param=[
                             ...
                             {'effect_type': 'buff', 'buffs': {'defense_multi': 3.3}, 'max_targets': 1,
                              ...
                              'cast_prob_lower_bound': 1.0, 'cast_prob_upper_bound': 1.0, }, ]),
                   Uni_attack]
...
Susie_skills = [Skill(name='苏茜技能', definition='active', type='instant',
                      effects_param=[
                          {'effect_type': 'skill_dmg', 'dmg_coef': 0.6, 'max_targets': 2, 'target_area': 'single'},
                          {'effect_type': 'buff', 'buffs': {'atk_dmg_deal_inc': -0.375}, 'max_targets': 3,
...
FemaleDoctor_skill = [Skill(name='女医生技能', definition='active', type='instant',
                            effects_param=[
                                {'effect_type': 'heal', 'heal_coef': 3 / 25 * 1.2, 'max_targets': 2, 'target_area': 'single',
                                 'target_type': 'ally'}, ]),
                      Uni_attack]
...
Nancy_skill = [Skill(name='南希技能', definition='active', type='instant',
                     effects_param=[
                         {'effect_type': 'skill_dmg', 'dmg_coef': 0.35, 'max_targets': 3, 'target_area': 'single'},
                         {'effect_type': 'burn', 'dmg_coef': 0.5, 'max_targets': 3, 'duration': 3,
                          'target_type': 'enemy',
                          'cast_prob_lower_bound': 1.0, 'cast_prob_upper_bound': 1.0, }, ]),
               Uni_attack]
